export type WidgetType = 'calendar' | 'slack' | 'obsidian' | 'docs' | 'todo' | 'weather' | 'tasks' | 'plaid' | 'stocks' | 'links' | 'notes' | 'wordle' | 'news' | 'typing' | 'shared_chess' | 'pomodoro' | 'lofi' | 'spotify' | 'f1' | 'football' | 'timezone';
