    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 8 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: compact ? 16 : 18, color: 'var(--accent)' }}>
          ...
          <>
            ...
            {hover && hovered && (
              <div style={{
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: lineColor, whiteSpace: 'nowrap', letterSpacing: '-0.01em' }}>
                  {formatRate(hovered.rate)}
                </span>
                <span style={{ fontSize: 9, color: hColor, whiteSpace: 'nowrap' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: compact ? 8 : 12, gap: compact ? 8 : 10, overflowY: 'auto', scrollbarWidth: 'none' }}>
            ...
            <div style={{ flexShrink: 0 }}>
              <div style={{
                ...
                <span style={{ fontSize: compact ? 16 : 20, fontWeight: 700, color: 'var(--text-muted)', flexShrink: 0 }}>
                  {fromMeta.symbol}
                </span>
                <input
                  value={displayAmount}
              ...
              {result ? (
                <>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                    ...
                    />
                    <span style={{ fontSize: compact ? 12 : 15, color: 'var(--text-muted)', fontWeight: 600 }}>
                      {toCode}
                    </span>
                  </div>
        ...
        {panelView === 'converter' && (
          <div style={{ flex: 1, overflowY: 'auto', padding: 14, display: 'flex', flexDirection: 'column', gap: 12, scrollbarWidth: 'none' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 10, padding: '8px 10px' }}>
              <span style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-muted)', flexShrink: 0 }}>{fromMeta.symbol}</span>
              <input
                value={displayAmount}
                onChange={e => onAmountChange(e.target.value)}
                style={{ flex: 1, background: 'none', border: 'none', outline: 'none', fontSize: 16, fontWeight: 700, color: 'var(--text)', minWidth: 0 }}
            ...
            {result && (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '4px 0' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                  ...
                  <span style={{ fontSize: 13, color: 'var(--text-muted)', fontWeight: 600 }}>{toCode}</span>
                </div>
                <span style={{ fontSize: 10, color: 'var(--text-faint)' }}>
                  1 {fromCode} = {formatRate(result.rate)} {toCode}
                </span>
