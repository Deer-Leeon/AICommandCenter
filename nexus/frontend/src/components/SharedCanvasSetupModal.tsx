/**
 * SharedCanvasSetupModal — shown when the user drops the Drawing Canvas widget.
 * Follows the exact same pattern as SharedPhotoSetupModal.
 */
...
export function SharedCanvasSetupModal({ onConfirm, onCancel, onOpenConnections }: Props) {
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
            ...
            <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: 'var(--text)' }}>
              Set Up Your Drawing Canvas
            </h2>
          </div>
          <p style={{ margin: 0, fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5 }}>
            Draw together in real time — both of you draw on the same canvas simultaneously and see each other's strokes appear live.
          </p>
        </div>
